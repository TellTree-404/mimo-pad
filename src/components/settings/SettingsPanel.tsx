...
export function SettingsPanel({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/60 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-[var(--border)]" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
        ...
        <div className="flex-1 overflow-y-auto p-5" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
          {tab === 'models' && (
            <ModelConfig
        ...
        <div className="shrink-0 p-4 border-t border-[var(--border)] text-center space-y-2 bg-[var(--bg-secondary)]" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
